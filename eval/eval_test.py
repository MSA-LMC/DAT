...
# from src.L_no88 import mymodel
import pandas as pd
...
def read_label(label_dir, role):
    ...
    if role == 'novice':
        file = os.path.join(label_dir, "novice.engagement.annotation.csv")
    else:
        file = os.path.join(label_dir, "expert.engagement.annotation.csv")
...
# 定义评估函数
def evaluate(model, device, label_dir, role):
    ypred = [] #定义模型预测值
    ...
    #     pred_values[i] = (pred_values[i]+pred_values[i+1])/2
...
if __name__ == "__main__":
    ...
    # # 建立初始化模型：
    # # model = mymodel()
    # model = CrossenhancedCEAM(768, 8, 768 * 4, 1, 1, 2, 0.2,
    #                           'fixed', 96, 0.5)
    ...
    # checkpoint_path_1 = f'/home/u2023110082/yuyangchen/MEE24/NO1_lastyear/Dialogue-Cross-Enhanced-CEAM-main/model_weight/Noxi/best_score_random_40.pt'
    # checkpoint_path_2 = f'/home/u2023110082/yuyangchen/MEE24/NO1_lastyear/Dialogue-Cross-Enhanced-CEAM-main/model_weight/Noxi/best_score_random_41.pt'
    # checkpoint_path_3 = f'/home/u2023110082/yuyangchen/MEE24/NO1_lastyear/Dialogue-Cross-Enhanced-CEAM-main/model_weight/Noxi/best_score_random_42.pt'
    # checkpoint_path_4 = f'/home/u2023110082/yuyangchen/MEE24/NO1_lastyear/Dialogue-Cross-Enhanced-CEAM-main/model_weight/Noxi/best_score_random_43.pt'
    # checkpoint_path_1 = f'/home/u2023110082/yuyangchen/MEE24/NO1_lastyear/Dialogue-Cross-Enhanced-CEAM-main/model_weight/Noxi/L_32_best_score_random_40_no1024.pt'
    checkpoint_path_1 = f'/home/u2023110082/yuyangchen/MEE24/NO1_lastyear/Dialogue-Cross-Enhanced-CEAM-main/model_weight/Noxi/M_partnet_32_best_loss_random_40_cross5_1.pt'
    checkpoint_path_2 = f'/home/u2023110082/yuyangchen/MEE24/NO1_lastyear/Dialogue-Cross-Enhanced-CEAM-main/model_weight/Noxi/M_partnet_32_best_loss_random_40_cross5_2.pt'
    checkpoint_path_3 = f'/home/u2023110082/yuyangchen/MEE24/NO1_lastyear/Dialogue-Cross-Enhanced-CEAM-main/model_weight/Noxi/M_partnet_32_best_loss_random_40_cross5_3.pt'
    checkpoint_path_4 = f'/home/u2023110082/yuyangchen/MEE24/NO1_lastyear/Dialogue-Cross-Enhanced-CEAM-main/model_weight/Noxi/M_partnet_32_best_loss_random_40_cross5_4.pt'
    checkpoint_path_5 = f'/home/u2023110082/yuyangchen/MEE24/NO1_lastyear/Dialogue-Cross-Enhanced-CEAM-main/model_weight/Noxi/M_partnet_32_best_loss_random_40_cross5_5.pt'
    # checkpoint_path_1 = f'/home/u2023110082/yuyangchen/MEE24/NO1_lastyear/Dialogue-Cross-Enhanced-CEAM-main/model_weight/Noxi/L_32_best_loss_random_40_no88.pt'
    ...
    # anno = couple_label_path("/home/u2023110082/NewDataset/Noxi/cross5/")
    anno = couple_label_path("/home/u2023110082/datasets/noxi-base")
    # anno = couple_label_path("/home/u2023110082/datasets/noxi-additional")
    print(anno)
    ...
    role_list = ["novice", "expert"]
    for i in anno:
        for j in role_list:

            pred_1 = evaluate(model_1, device, i, j)

            pred_2 = evaluate(model_2, device, i, j)

            pred_3 = evaluate(model_3, device, i, j)

            pred_4 = evaluate(model_4, device, i, j)

            pred_5 = evaluate(model_5, device, i, j)
            # 评估模型
            ...
            # label_values = label_values[:len(pred_1)]
            ...
            # pred_random = np.random.rand(len(pred_1))

            df = pd.DataFrame(pred_average)
            df.to_csv(os.path.join("/home/u2023110082/prediction/noxi-base",os.path.basename(i), j+".engagement.annotation.csv"), header=False, index=False)
            # df.to_csv(os.path.join(i, j+".engagement.annotation_pred.csv"), header=False, index=False)
            # print("saved!!!")
    #

...
def parse_arguments():
    ...
    parser.add_argument('--seed_value', type=int, default=40,
                        help='Random seed')
...
if __name__ == "__main__":
    ...
    # 加载pre_dataset:
    train_dataset = CustomDataset("/data/public_datasets/MEE_2024/Noxi/train", modalities, "Noxi_train")
    val_dataset = CustomDataset("/data/public_datasets/MEE_2024/Noxi/val", modalities, "Noxi_val")
    ...
    for epoch in tqdm(range(args.epochs)):
        ...
        with torch.no_grad():
            ...
            for i, data in enumerate(valloader, 0):
                ...
                outputs = model_ema(inputs,partnet_inputs)
        ...
        if val_loss[-1] < val_loss_flag:
            ...
            model_save_path = 'model/noxi_random_40'
